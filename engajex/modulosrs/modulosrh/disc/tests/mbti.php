...
$stmt = $db->prepare("
    ...
    WHERE candidate_id = ? AND test_type = 'mbti'
");
    ...
    if (!empty($answers)) {
        try {
            ...
            foreach ($answers as $questionId => $answer) {
                // Mapear respostas para dimensões MBTI
                switch ($questionId % 4) {
                    case 0: // E/I
                        $answer === 'A' ? $dimensions['E']++ : $dimensions['I']++;
                        break;
                    case 1: // S/N
                        $answer === 'A' ? $dimensions['S']++ : $dimensions['N']++;
                        break;
                    case 2: // T/F
                        $answer === 'A' ? $dimensions['T']++ : $dimensions['F']++;
                        break;
                    case 3: // J/P
                        $answer === 'A' ? $dimensions['J']++ : $dimensions['P']++;
                        break;
                }
            }
...
// Buscar questões do teste MBTI do banco de dados
...
<head>
    ...
    <title>Teste MBTI - Sistema de Testes</title>
...
<body>
    ...
    <div class="container my-4">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h2 class="text-center mb-4">Teste MBTI</h2>
                
                <div class="alert alert-info mb-4">
                    <h5><i class="bi bi-info-circle me-2"></i>Instruções:</h5>
                    <p class="mb-0">
                        Para cada pergunta, escolha a opção que melhor descreve como você geralmente se sente ou age.
