...
<head>
    ...
    <title>Registrar Candidato MBTI - Sistema DISC</title>
        ...
        <div class="content-container">
            ...
            <?php if (isset($_GET['success']) && $_GET['success'] == '1'): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Candidato MBTI registrado com sucesso!
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php endif; ?>

            <form action="process_candidate_mbti.php" method="POST" class="needs-validation" novalidate>
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-lg"></i> Registrar Candidato MBTI
                    </button>
