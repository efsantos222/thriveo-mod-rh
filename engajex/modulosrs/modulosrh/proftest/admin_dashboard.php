                            ...
                            <tbody>
                                <?php foreach ($candidatos as $candidato): ?>
                                    <tr>
                                        ...
                                        <td><span class="badge bg-<?php echo $candidato['tipo'] === 'DISC' ? 'primary' : 'success'; ?>"><?php echo $candidato['tipo']; ?></span></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
