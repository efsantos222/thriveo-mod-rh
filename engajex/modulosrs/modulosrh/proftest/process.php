...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['selecionador_nome'])) {
        ...
        $questao_atual = $_SESSION['questao_atual'] ?? 0;
        ...
        if ($_SESSION['questao_atual'] >= count($questions)) {
            ...
            $body .= "<h3>Perfil Predominante:</h3>";
            $body .= "{$analise['recomendacao']}<br><br>";
            $body .= "Em anexo você encontrará o arquivo com todas as respostas e o gráfico do perfil.";
            ...
            // Buscar e-mail do selecionador
            if (isset($_SESSION['user_data']['selecionador_email'])) {
                mail($_SESSION['user_data']['selecionador_email'], $subject, $body, [
