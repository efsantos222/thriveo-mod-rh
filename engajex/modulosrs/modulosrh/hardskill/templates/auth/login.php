...
<head>
    ...
    <title>TestProf HardSkill - Login Corporativo</title>
...
<body>
    ...
    <section class="hero-section">
        <div class="container hero-container">
            <!-- Left: Text -->
            <div class="hero-text">
                <h1>Avaliação de <br> HardSkills</h1>
                <p>Avalie competências técnicas com precisão através de testes especializados, baseados na especificação do cargo. Total conformidade
                    com a LGPD.</p>
    ...
    <section id="features" class="features-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Tudo o que você precisa para avaliar Hardkills da sua equipe ou candidatos</p>
            </div>
    ...
    <section id="access" class="footer-section">
        <div class="container">
            ...
            <p class="footer-subtitle">Para implementar o Sistema de Avaliação de HardSkills na sua empresa, entre em
                contato
                conosco.</p>
