...
class User
{
    ...
    public function login($email, $password)
    {
        ...
        // Prefer records with recruiter_id set (avoids returning SSO-created duplicates)
        $query = 'SELECT * FROM ' . $this->table . ' WHERE email = :email ORDER BY (recruiter_id IS NULL) ASC, id DESC LIMIT 1';
