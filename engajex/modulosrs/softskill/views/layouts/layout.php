<?php
$role = $_SESSION['ss_role'] ?? 'guest';
$userName = $_SESSION['ss_user_name'] ?? 'Visitante';
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav>
                <?php if ($role === 'admin' || ($_SESSION['role'] ?? '') === 'admin'): ?>
                ...
                <?php elseif ($role === 'recruiter' || in_array($_SESSION['role'] ?? '', ['responsible', 'manager'])): ?>
                    ...
                    <a href="<?php echo BASE_URL; ?>recruiter/questions" class="nav-link">Questões</a>
                <?php elseif ($role === 'candidate'): ?>
                    <a href="<?php echo BASE_URL; ?>candidate/dashboard" class="nav-link">Meus Testes</a>
                <?php endif; ?>
                <a href="<?php echo BASE_URL; ?>public/back_to_system.php" class="nav-link"
                    style="margin-top: auto; color: var(--primary)">← Voltar ao Sistema</a>
                <a href="<?php echo BASE_URL; ?>logout" class="nav-link"
                    style="color: var(--danger)">Sair</a>
            </nav>
        </aside>
