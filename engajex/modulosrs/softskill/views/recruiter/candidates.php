...
<div class="card">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem">
        ...
        <a href="<?php echo BASE_URL; ?>recruiter/importUsers" class="action-btn" style="background:var(--secondary); color:white; border:none; padding: 0.6rem 1.2rem; text-decoration:none">Importar da Empresa</a>
    </div>
    <table class="table">
        <thead>
            <tr>
